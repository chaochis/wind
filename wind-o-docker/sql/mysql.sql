create table if not exists wind_account
(
    ...
    account_status       int                       not null comment '账号状态 0 - 未激活 1 - 正常 2 - 已删除',
    account_status_text  varchar(600) charset utf8 not null comment '账号状态中文解释',
    user_id              varchar(255)              not null comment '关联的用户id',
    account_create_by_id varchar(255)              not null comment '创建该账户的user_id',
    account_create_date  datetime                  not null comment '创建该账户的时间',
    account_update_by_id varchar(255)              not null comment '最近一次更新账户关联的人的user_id',
    account_update_date  datetime                  not null comment '最近一次更新账户关联的时间',
    account_login_ip     varchar(255)              not null comment '该账号最近一次的登录ip',
    account_login_date   datetime                  not null comment '该账号最近一次的登录时间',
    constraint wind_account_account_id_uindex
    unique (account_id)
    )
    comment '风旅账号表(关联用户表用)';

create table if not exists wind_department
(
    ...
    department_create_by_id varchar(255)              not null comment '部门创建人的userId',
    department_update_by_id varchar(255)              not null comment '最近一次更新部门信息的人的userId',
    department_update_date  datetime                  not null comment '最近一次更新部门信息的时间',
    department_create_date  datetime                  not null comment '部门创建时间',
    constraint wind_department_department_id_uindex
    unique (department_id)
    )
    comment 'wind部门表';

create table if not exists wind_permission
(
    ...
    permission_create_by_id   varchar(255)              not null comment '创建该权限的人的userId',
    permission_create_date    datetime                  not null comment '该权限的创建时间',
    permission_update_by_id   varchar(255)              not null comment '更新该权限信息的人的userId',
    permission_update_date    datetime                  not null comment '更新该权限信息的时间',
...
create table if not exists wind_role
(
    ...
    role_create_by_id varchar(255)              not null comment '角色创建人的userId',
    role_create_date  datetime                  not null comment '角色的创建时间',
    role_update_by_id varchar(255)              not null comment '最近一次更新角色信息的人的userId',
    role_update_date  datetime                  not null comment '最近一次更新角色信息的时间',
    constraint wind_role_role_id_uindex
    unique (role_id)
    )
    comment '风旅角色表';

create table if not exists wind_role_permission_relation
(
    relation_id           varchar(255) not null comment '关联id'
    primary key,
    permission_id         varchar(255) not null comment '权限id',
    role_id               varchar(255) not null comment '角色id',
    relation_create_by_id varchar(255) not null comment '创建该关联关系的人的userId',
    relation_create_date  datetime     not null comment '该关联的创建时间',
    constraint wind_role_permission_relation_relation_id_uindex
    unique (relation_id)
    )
    comment '用户角色权限关联表';

create table if not exists wind_user
(
    user_id            varchar(255)              not null comment '用户主键'
    primary key,
    user_name          varchar(255) charset utf8 not null comment '用户名',
    user_email         varchar(64)               null comment '用户邮箱',
    user_mobile        varchar(20)               null comment '用户手机号',
    user_password      varchar(20)               null comment '用户的密码',
    ...
    user_create_by_id  varchar(255)              null comment '创建人的userId',
    user_create_date   datetime                  null comment '创建时间',
    user_update_by_id  varchar(255)              null comment '最近一次更新用户信息的人的userid',
    user_update_date   datetime                  null comment '最近一次更新用户信息的时间',
    constraint wind_user_user_email_uindex
    unique (user_email),
    constraint wind_user_user_id_uindex
    unique (user_id),
    constraint wind_user_user_name_uindex
    unique (user_name),
...
create table if not exists wind_user_department_relation
(
    relation_id           varchar(255) not null comment '关联id'
    primary key,
    user_id               varchar(255) not null comment '用户id',
    department_id         varchar(255) not null comment '部门id',
    relation_create_by_id varchar(255) not null comment '创建该关联的人的userId',
    relation_create_date  datetime     not null comment '创建时间',
    constraint wind_user_department_relation_relation_id_uindex
    unique (relation_id)
    )
    comment '风旅用户部门关联表';

create table if not exists wind_user_group
(
    ...
    user_group_create_by_id    varchar(255)              not null comment '创建该用户组的人的userId',
    user_group_create_date     datetime                  not null comment '创建该用户组的时间',
    user_group_update_by_id    varchar(255)              not null comment '最近一次更新该用户组的人的userId',
    user_group_update_date     varchar(255)              not null comment '最近一次更新该用户组的时间',
...
create table if not exists wind_user_group_role_relation
(
    relation_id           varchar(255) not null comment '主键'
    primary key,
    user_group_id         varchar(255) not null comment '用户组id',
    role_id               varchar(255) not null comment '角色id',
    relation_create_by_id varchar(255) not null comment '关联创建人的userId',
    relation_create_date  datetime     not null comment '关联创建时间',
    constraint wind_user_group_role_relation_relation_id_uindex
    unique (relation_id)
    )
    comment '用户组角色关联表';

create table if not exists wind_user_group_user_relation
(
    relation_id           varchar(255) not null comment '关联id'
    primary key,
    user_id               varchar(255) not null comment '用户id',
    user_group_id         varchar(255) not null comment '用户组id',
    relation_create_by_id varchar(255) not null comment '创建该关联的人的user_id',
    relation_create_date  datetime     not null comment '创建该关联的时间',
    constraint wind_user_group_user_relation_relation_id_uindex
    unique (relation_id)
    )
    comment '用户与用户组关联表';

create table if not exists wind_user_role_relation
(
    user_id               varchar(255) not null comment '用户id',
    role_id               varchar(255) not null comment '角色id',
    relation_id           varchar(255) not null comment '关联id'
    primary key,
    relation_create_by_id varchar(255) not null comment '创建关联信息的创建人的userId',
    relation_create_date  datetime     not null comment ' 创建关联信息的时间',
